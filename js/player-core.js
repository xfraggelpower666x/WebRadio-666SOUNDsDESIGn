...
import { createBars, startVisualizer } from './equalizer.js?v=2026-09-05-main-header-brand-v1';
...
(function installV80StreamStabilityMbLedRepair(){
  ...
  function setChipLabels(){
    ...
    if(main){
      ...
      main.setAttribute('aria-label','Main Stream');
