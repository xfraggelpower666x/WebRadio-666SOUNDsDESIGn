/*
 * 666SOUNDsDESIGn Discord Shooter — public frontend bridge.
 * Webhook URLs stay server-side in Worker secrets. No Discord password gate.
 */
(function () {
  'use strict';

  var VERSION = 'V4.4-20260715-NO-PASSWORD-DISCORD-SHOOTER';
  var inFlight = false;
  var watcherTimer = 0;
  var lastTrackKey = '';
  var lastPostedKey = '';
