...
.lamp-box, .pill, .mini-box, .display-window, .control-btn, .small-btn, .volume-wrap {
...
.lamp-label, .display-label, .boot-subtitle, .boot-note, .mini-label, .volume-wrap label {
  color: var(--muted);
}
.pill-row {
  display: flex;
...
.pill { padding: 8px 12px; font-size: 0.92rem; }
...
function passthroughHeaders(sourceHeaders) {
  ...
  const allow = [
    ...
    "icy-br","icy-description","icy-genre","icy-metaint","icy-name","icy-notice1",
    "icy-notice2","icy-pub","icy-url","transfer-encoding"
  ];
