// JS FIX FINAL
// Player remains separated in repo files.
// Main fix: remove ES module import path dependency for iPhone/browser compatibility.
// Delivery stays on same root URL query assets to avoid path/caching issues.
...
const APP_JS = `const STREAM_CONFIG = window.STREAM_CONFIG || {};
...
const CONFIG_JS = `window.STREAM_CONFIG = {
  "stream_url": "/stream",
