 ...
 *
 * ZIEL:
 * - /stream muss stabil laufen
 * - kompatibel mit altem + neuem Frontend
 * - robust gegen kaputte HEAD-Checks
 * - Webhook bevorzugen, Provider als Fallback
 * - Backup-Stream automatisch nutzbar
 * - keine unnötige Komplexität im Audio-Pfad
 *
 * ENDPOINTS:
 * GET/HEAD  /stream
...
async function quickStreamProbe(url, timeoutMs) {
  ...
  try {
    // Viele Streamserver hassen HEAD. Deshalb kleiner GET mit Range.
    ...
    // 200, 206, manchmal 416 bei Streams/Proxy-Kanten ist noch okay genug
...
async function selectBestStream(mainStream, backupStream, timeoutMs) {
  ...
  // Self-heal emergency:
  // lieber main trotzdem versuchen als komplettes 503.
